...
- [ITERATION_V70_T104](iterations/ITERATION_V70_T104.md)（**线上拒绝并回滚**：T104 = 10牛/4羊 表 + V50 执行层。本地 h2h vs V50 17W-1L 通过闸门，提交 55634837，但线上平衡 ~1633 远低于 V50 实时 1660-1858 → **本地 tape h2h 不预测线上（第二次证实现：V60→1232、v70→1633）**。回滚 V50（重提 55640613），改配比判定为负收益并冻结）
- [SUB_CHECKPOINT_55640613_V50_ROLLBACK](submissions/SUBMISSION_REVIEW_55634837.md)（V50 8/4 回滚重提 55640613；该抽样池平衡 ~1660-1675，高于 v70 的 1633，确认回滚正确；同一代码因匹配抽样各红抽 1660/1781/1858 不等）
