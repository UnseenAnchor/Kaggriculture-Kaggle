...
6. **本地 tape h2h 不能预测线上分数（本会话第二次证实）**：V60(6/8) 本地 10W-2L→线上 1232；v70(10/4) 本地 18W-0L→线上 1633，双双低于 V50 的 1770-1858。配比/RPS 优化在本地胜率高但线上负，唯一线上验证过的工件是 V50 8/4。**改配比是预期负收益，不应再花提交次数尝试。**
