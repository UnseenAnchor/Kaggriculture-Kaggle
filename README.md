...
6. **本地 tape h2h 不能预测线上分数（本会话第二次证实）**：V60(6/8) 本地 10W-2L→线上 1232；v70(10/4) 本地 18W-0L→线上 1633，双双低于 V50 的 1770-1858。配比/RPS 优化在本地胜率高但线上负，唯一线上验证过的工件是 V50 8/4。**改配比是预期负收益，不应再花提交次数尝试。**（V50 回滚重提 55640613，该抽样池平衡 1660-1675 > v70 1633，确认回滚正确。）

## 下一步

- [x] **T104（10牛/4羊）候选已通过本地闸门**：h2h vs V50 17W-1L、starter/hamburger 无回归（唯一代价是 sheep-heavy 稀有族 0W-8L）。待用户授权替换 baseline 并提交（见 [ITERATION_V70_T104](docs/reviews/iterations/ITERATION_V70_T104.md)）。- [x] 建立官方环境、固定种子双-seat评测与公开精英 tape 对照
