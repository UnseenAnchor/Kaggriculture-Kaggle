"""Full local gate for bare 93730164 6cow/12sheep dominant branch: starter, Hamburger, failure families, and V50 head-to-head."""
from concurrent.futures import ProcessPoolExecutor
from pathlib import Path
import statistics

ROOT = Path(__file__).resolve().parents[1]
CAND = str((ROOT / 'research/agents/online/episode_94155162_opponent.py').resolve())
