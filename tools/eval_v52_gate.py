"""Full local gate for V52 93730164 dominant branch + V50 execution layer: starter, Hamburger, failure families, and V50 head-to-head."""
from concurrent.futures import ProcessPoolExecutor
from pathlib import Path
import statistics

ROOT = Path(__file__).resolve().parents[1]
CAND = str((ROOT / 'research/agents/v52_expansion_dominant.py').resolve())
