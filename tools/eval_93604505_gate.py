"""Full local gate for the 93604505 expansion route: starter, Hamburger, failure families, and V50 head-to-head."""
from concurrent.futures import ProcessPoolExecutor
from pathlib import Path
import statistics

ROOT = Path(__file__).resolve().parents[1]
CAND = str((ROOT / 'research/agents/online/episode_93604505_opponent.py').resolve())
