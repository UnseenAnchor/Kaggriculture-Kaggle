"""Full local gate for V53 8cow/6sheep (ep 94155162) + V50 execution layer: starter, Hamburger, failure families, and V50 head-to-head."""
from concurrent.futures import ProcessPoolExecutor
from pathlib import Path
import statistics

ROOT = Path(__file__).resolve().parents[1]
CAND = str((ROOT / 'research/agents/v53_8cow6sheep_exec.py').resolve())
